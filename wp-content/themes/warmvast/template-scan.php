...
// Visually the scan card is the whole hero -- no competing copy column --
// but the page still needs a real h1 for SEO/a11y, just not a visible one
// duplicating what the card's own heading ("Doe de isolatiescan voor uw
// woning") already says on screen: title_sr_only handles that.
//
// Same 'home' variant as the homepage (same dark surface, same USP set) --
// not a second dark template. See warmvast_the_hero() in inc/template-tags.php.
warmvast_the_hero(
	array(
		'variant'       => 'home',
		'title'         => 'Bereken in 2 minuten wat isoleren u oplevert',
		'title_sr_only' => true,
